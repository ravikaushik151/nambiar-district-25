        ...
        <footer className="footer" id='contact'>
            ...
            <div className="footer-bottom">
                <p>
                    ...
                    <br />
                    Please read our <Link href="/terms-and-conditions" target="_blank" rel="noopener noreferrer">Terms & Conditions</Link> and <Link href="/privacy-policy" target="_blank" rel="noopener noreferrer">Privacy Policy</Link>.
                </p>
            </div>
